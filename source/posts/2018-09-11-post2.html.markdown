...
<header>
<h2>Explanations and examples of every<br> (yes, every) HTML element.</h2>
...
<li>
  <strong>&#60;meta&#62;</strong> tag defines the metadata that describes a webpage using keywords and short descriptions for Search Engine Optimization.
