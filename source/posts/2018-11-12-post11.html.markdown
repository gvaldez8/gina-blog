...
<main class='blogposts__container'>
  ...
  <p>This is the most important phase, as it’s the kick-off to any project that you start and will determine the tone
    for the entire process from start to finish. This phase requires extensive planning and research. The Research
    Process is determined into the following segments: The Research Plan,
    Research Methods, Conducting the User Research, and Discovery.</p>
  ...
  <ol class="blogpost--ol-indent">
    ...
    * Field research
    * Diary studies
    * Surveys— This isn’t always the most helpful just because some users take these as opportunities to rant.
    * Guerrilla research
    * User research, user interviews, and user flows

    <li><strong>Secondary Research — </strong> These are collected third-party research conducted into the
      user
      population, such as:</li>
    * Publicly available research
    * Research conducted from other parts of the organization (i.e. marketing segmentation). Note that this will be
    amongst the most useful to UX Professionals

    <li><strong>Personas, Mental Models, and User Stories — </strong> These are documents that synthesize what you’ve
      learned about users through the aforementioned methods all distilled into key points, such as:</li>

    <ul class="blogpost--ul-indent">
      <li>Supporting diagrams (i.e. contextual inquiry, competitor analysis, product assessment)</li>
      <li>Stories for how a product fits into users’ lives (i.e. proto-personas)</li>
      <li>Usability testing</li>
      <li>User flows</li>
    </ul>
  </ol>
  ...
  <hr />
  <p>Refer to your <strong>Research Plan</strong> for the users that you will interview and tailor your questions
    accordingly. Each
    interview should take on average anywhere from 1–2hrs and no shorter than 30mins minimum. You can think of the type
    of users you interview and how that will influence your questions in two groups:</p>
  <ol class="blogpost--ol-indent">
  ...
  <h5 class="helper-space-top"><strong>PREP WORK</strong></h5>
  <hr />
  ...
  <p>Similar to a problem statement, a solution statement is a concise description of how you intend to solve your
    ...
    users’
    problems or improve their feelings and perception of the product. Below are some tips that can help you write them:</p>
  <ol class="blogpost--ol-indent">
  ...
  <ul class="blogpost--ul-indent">
    ...
    <li><a href="https://projects.iq.harvard.edu/files/harvarduxgroup/files/ux-research-guide-sample-questions-for-user-interviews.pdf">Harvard's
        UX Research Guide Sample Questions for User Interviews</a></li>
